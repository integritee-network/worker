...
use itp_stf_state_handler::{
	file_io::StatePathProvider, handle_state::HandleState, query_shard_state::QueryShardState,
...
pub(crate) fn init_enclave(
	...
	let state_file_io =
		Arc::new(EnclaveStateFileIo::new(state_key_repository, StatePathProvider::new(base_dir)));
