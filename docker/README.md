...
* The node image version that is loaded in the `<(envsubst < docker-compose.yml)`, (e.g. `image: "integritee/integritee-node-dev:1.0.32"`) needs to be compatible with the worker you're trying to build.
