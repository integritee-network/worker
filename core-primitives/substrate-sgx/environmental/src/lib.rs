...
//! Therefore, this crate introduces the sgx feature, which allows multithreading within an sgx enabled envinronment.
//! It should be ensured, that all uses of the environmental crate within the enclave are makeing use of this crate, not the original one.
//!
//! Attention: The `sp-runtime-interface` still points to the original environmental crate. It's not easily patchabled due
...
//! Nonetheless, it shold be kept in mind, that this may cause a problem in the future.
