...
use runtime_primitives::{
    create_runtime_str, generic, traits::BlakeTwo256, weights::Weight, Perbill,
};
...
impl ::support::sr_primitives::traits::GetRuntimeBlockType for Runtime {
...
impl Into<::support::rstd::result::Result<system::Origin<Runtime>, Origin>> for Origin {
    fn into(self) -> ::support::rstd::result::Result<system::Origin<Runtime>, Self> {
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
    spec_name: create_runtime_str!("sgx-trusted"),
        ...
        fn decode<DecIn: _codec::Input>(
            ...
            match input.read_byte()? {
                x if x == 0usize as u8 => Ok(Event::system({
                    let res = _codec::Decode::decode(input);
                    match res {
...
impl ::support::rstd::convert::TryInto<indices::Event<Runtime>> for Event {
    type Error = ();
    fn try_into(self) -> ::support::rstd::result::Result<indices::Event<Runtime>, Self::Error> {
        match self {
...
impl ::support::rstd::convert::TryInto<balances::Event<Runtime>> for Event {
    type Error = ();
    fn try_into(self) -> ::support::rstd::result::Result<balances::Event<Runtime>, Self::Error> {
        match self {
