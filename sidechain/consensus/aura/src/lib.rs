...
use its_primitives::{
	traits::{Block as SidechainBlockTrait, Header as HeaderT, SignedBlock},
...
type ShardIdentifierFor<SignedSidechainBlock> =
	<<<SignedSidechainBlock as SignedBlock>::Block as SidechainBlockTrait>::HeaderType as HeaderT>::ShardIdentifier;
